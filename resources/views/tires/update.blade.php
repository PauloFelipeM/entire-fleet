...
<div class="content">
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
          <form method="post" action="{{url('/tires/store/'.$tire->id)}}" autocomplete="off" class="form-horizontal">
            @csrf
            <div class="card ">
                ...
                <div class="col-md-3">
                  ...
                  <div class="form-group{{ $errors->has('serie_number') ? ' has-danger' : '' }}">
                    <input class="input-upper form-control{{ $errors->has('serie_number') ? ' is-invalid' : '' }}" required
                      name="serie_number" id="input-serie_number" type="text" value="{{ old('serie_number', $tire->serie_number) }}"/>
                    @error('serie_number')
                ...
                <div class="col-md-3">
                  ...
                  <div class="form-group{{ $errors->has('brand') ? ' has-danger' : '' }}">
                    <input class="form-control{{ $errors->has('brand') ? ' is-invalid' : '' }}" 
                      required name="brand" id="input-brand" type="text" value="{{ old('brand', $tire->brand) }}"/>
                    @error('brand')
                ...
                <div class="col-md-3">
                  ...
                  <div class="form-group{{ $errors->has('dimension') ? ' has-danger' : '' }}">
                    <input class="form-control{{ $errors->has('dimension') ? ' is-invalid' : '' }}" required
                      name="dimension" id="input-dimension" type="text" value="{{ old('dimension', $tire->dimension) }}"/>
                    @error('dimension')
                ...
                <div class="col-md-3">
                  ...
                  <div class="form-group{{ $errors->has('note_number') ? ' has-danger' : '' }}">
                    <input class="form-control{{ $errors->has('note_number') ? ' is-invalid' : '' }}" required
                      name="note_number" id="input-note_number" type="text" value="{{ old('note_number', $tire->note_number) }}"/>
                    @error('note_number')
                  ...
                  <div class="form-group{{ $errors->has('provider_id') ? ' has-danger' : '' }}">                      
                    <select class="form-control{{ $errors->has('provider_id') ? ' is-invalid' : '' }}" name="provider_id" id="input-provider_id" required>
                      ...
                      @foreach($providers as $provider)
                        @if ($tire->provider_id == $provider->id)
                ...
                <div class="col-md-2">
                  ...
                  <div class="form-group{{ $errors->has('km_total') ? ' has-danger' : '' }}">
                    <input class="form-control{{ $errors->has('km_total') ? ' is-invalid' : '' }}" 
                      required name="km_total" id="input-km_total" type="number" step="0.01" value="{{ old('km_total', $tire->km_total) }}"/>
                    @error('km_total')
                ...
                <div class="col-md-2">
                  ...
                  <div class="form-group{{ $errors->has('value') ? ' has-danger' : '' }}">
                    <input class="form-control{{ $errors->has('value') ? ' is-invalid' : '' }}" 
                      required name="value" min="4" id="input-value" type="number" step="0.01" value="{{ old('value', $tire->value) }}"/>
                    @error('value')
                ...
                <div class="col-md-2">
                  ...
                  <div class="form-group{{ $errors->has('validate_date') ? ' has-danger' : '' }}">
                    <input class="form-control{{ $errors->has('validate_date') ? ' is-invalid' : '' }}" 
                      required name="validate_date" id="input-validate_date" type="date" value="{{ old('validate_date', $tire->validate_date) }}"/>
                    @error('validate_date')
                ...
                <div class="col-md-2">
                  ...
                  <div class="form-group{{ $errors->has('purchase_date') ? ' has-danger' : '' }}">
                    <input class="form-control{{ $errors->has('purchase_date') ? ' is-invalid' : '' }}" 
                      required name="purchase_date" id="input-purchase_date" type="date" value="{{ old('purchase_date', $tire->purchase_date) }}"/>
                    @error('purchase_date')
