...
<div class="content">
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
          <form method="post" action="{{url('/masterpoints/store/'.$masterPoint->id)}}" autocomplete="off" class="form-horizontal">
            @csrf
            <input name="latitude" id="latitude" value="{{old('latitude', $masterPoint->latitude)}}" type="hidden"/>
            <input name="longitude" id="longitude" value="{{old('longitude', $masterPoint->longitude)}}" type="hidden"/>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-12">
                      ...
                      <div class="form-group{{ $errors->has('title') ? ' has-danger' : '' }}">
                        ...
                        name="title" id="input-title" type="text" value="{{ old('title', $masterPoint->title) }}"/>
                        @error('title')
