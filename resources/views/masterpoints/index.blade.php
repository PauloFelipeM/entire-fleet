...
<div class="content">
  <nav aria-label="breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active" aria-current="page">{{__('masterpoint.title_pluralize')}}</li>
    </ol>
  </nav>
        ...
        <div class="card">
          <div class="card-header card-header-primary">
            <div class="row">
                ...
                <div class="col-md-3">
                <form action="/masterpoints" method="GET">
                @csrf
                  <div class="input-group no-border">
                      ...
                      <a href="{{url('masterpoints')}}" class="btn btn-white btn-round btn-just-icon ml-1 mr-1" data-toggle="tooltip" data-placement="top" title="{{__('transit.clear_filter')}}">
                ...
                <div class="col-md-8">
                  <div class="float-right">
                    <a href="{{url('/masterpoints/create')}}" class="btn btn-primary">{{ __('default.btn_create') }}</a>    
                    <a href="{{url('/masterpoints/trash')}}" title="{{__('default.btn_trash')}}" class="btn m-btn btn-secondary">
              ...
              <table class="table table-responsive">
                ...
                <tbody>
                  ...
                  <tr>
                      ...
                      <td class="font-w600">
                          <a href="{{url('/masterpoints/view/'.$masterPoint->id)}}">{{ $masterPoint->title }}</a>
                      </td>
                      ...
                      <td nowrap>
                          <a href="{{url('/masterpoints/update/'.$masterPoint->id)}}" class="btn btn-outline-secundary"
                              data-toggle="tooltip" data-placement="top" title="{{__('default.update')}}"><i class="fa fa-edit"></i></a>
                          <a href="javascript:modelDelete('{{$masterPoint->id}}', '{{$masterPoint->title}}')" class="btn btn-danger"
