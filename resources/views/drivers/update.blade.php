...
<div class="content">
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
          <form method="post" action="{{url('/drivers/store/'.$driver->id)}}" autocomplete="off" class="form-horizontal">
            @csrf
            <div class="card ">
                ...
                <div class="row">
                  ...
                  <div class="col-md-3">
                    ...
                    <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                      ...
                      name="name" id="input-name" type="text" value="{{ old('name', $driver->name) }}"/>
                      @error('name')
                  ...
                  <div class="col-md-3">
                    ...
                    <div class="form-group{{ $errors->has('email') ? ' has-danger' : '' }}">
                      ...
                      name="email" id="input-email" type="email" value="{{ old('email', $driver->email) }}"/>
                      @error('email')
                  ...
                  <div class="col-md-3">
                    ...
                    <div class="form-group{{ $errors->has('social_security') ? ' has-danger' : '' }}">
                      ...
                      name="social_security" id="input-social_security" type="text" value="{{ old('social_security', $driver->social_security) }}"/>
                  ...
                  <div class="col-md-3">
                    ...
                    <div class="form-group{{ $errors->has('phone') ? ' has-danger' : '' }}">
                      ...
                      name="phone" id="input-celphone" type="phone" value="{{ old('phone', $driver->phone) }}"/>
                      @error('phone')
                ...
                <div class="row">   
                  ...
                  <div class="col-md-3">
                    ...
                    <div class="form-group{{ $errors->has('driver_license') ? ' has-danger' : '' }}">
                      ...
                      name="driver_license" id="input-driver_license" type="text" value="{{ old('driver_license', $driver->driver_license) }}"/>
                  ...
                  <div class="col-md-3">
                    ...
                    <div class="form-group{{ $errors->has('driver_license_expiration') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('driver_license_expiration') ? ' is-invalid' : '' }}" required 
                        name="driver_license_expiration" id="input-driver_license_expiration" type="date" 
                        value="{{ old('driver_license_expiration', $driver->driver_license_expiration) }}"/>
                    ...
                    <div class="form-group{{ $errors->has('driver_license_category') ? ' has-danger' : '' }}">                      
                      <select class="form-control{{ $errors->has('driver_license_category') ? ' is-invalid' : '' }}" 
                        ...
                        @foreach($licenseCategories as $key => $licenseCategory)
                          @if ($driver->driver_license_category == $key)
                  ...
                  <div class="col-md-3">
                    ...
                    <div class="form-group{{ $errors->has('birth_date') ? ' has-danger' : '' }}">
                      ...
                      name="birth_date" id="input-birth_date" type="date" value="{{ old('birth_date', $driver->birth_date) }}"/>
                      @error('birth_date')
