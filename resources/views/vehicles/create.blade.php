...
<div class="content">
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
          <form method="post" action="{{url('/vehicles/store')}}" autocomplete="off" class="form-horizontal">
            @csrf
            <div class="card ">
                ...
                <div class="row">
                  ...
                  <div class="col-md-3">
                    ...
                    <div class="form-group{{ $errors->has('plate') ? ' has-danger' : '' }}">
                      <input class="input-upper form-control{{ $errors->has('plate') ? ' is-invalid' : '' }}" required name="plate" id="input-plate" type="text" value="{{ old('plate') }}"/>
                      @error('plate')
                  ...
                  <div class="col-md-3">
                    ...
                    <div class="form-group{{ $errors->has('document') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('document') ? ' is-invalid' : '' }}" 
                        required name="document" id="input-document" type="number" step="0.01" value="{{ old('document') }}"/>
                      @error('document')
                  ...
                  <div class="col-md-3">
                    ...
                    <div class="form-group{{ $errors->has('color') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('color') ? ' is-invalid' : '' }}" required name="color" id="input-color" type="text" value="{{ old('color') }}"/>
                      @error('color')
                    ...
                    <div class="form-group{{ $errors->has('vehicle_type_id') ? ' has-danger' : '' }}">                      
                      <select class="form-control{{ $errors->has('vehicle_type_id') ? ' is-invalid' : '' }}" name="vehicle_type_id" id="input-vehicle_type_id" required>
                        ...
                        @foreach($vehicletypes as $vehicletype)
                          @if (Input::old('vehicle_type_id') == $vehicletype->id)
                  ...
                  <div class="col-md-2">
                    ...
                    <div class="form-group{{ $errors->has('km_started') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('km_started') ? ' is-invalid' : '' }}" 
                        required name="km_started" id="input-km_started" type="number" step="0.01" value="{{ old('km_started') }}"/>
                      @error('km_started')
                  ...
                  <div class="col-md-2">
                    ...
                    <div class="form-group{{ $errors->has('manufacture_year') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('manufacture_year') ? ' is-invalid' : '' }}" 
                        required name="manufacture_year" min="4" id="input-manufacture_year" type="number" value="{{ old('manufacture_year') }}"/>
                  ...
                  <div class="col-md-2">
                    ...
                    <div class="form-group{{ $errors->has('model_year') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('model_year') ? ' is-invalid' : '' }}" 
                        required name="model_year" id="input-model_year" type="number" min="4" value="{{ old('model_year') }}"/>
                      @error('model_year')
