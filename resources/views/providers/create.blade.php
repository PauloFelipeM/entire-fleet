...
<div class="content">
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
          <form method="post" action="{{url('/providers/store')}}" autocomplete="off" class="form-horizontal">
            @csrf
            <div class="card ">
                ...
                <div class="row">
                  ...
                  <div class="col-md-4">
                    ...
                    <div class="form-group{{ $errors->has('social_name') ? ' has-danger' : '' }}">
                      ...
                      name="social_name" id="input-social_name" type="text" value="{{ old('social_name') }}"/>
                      @error('social_name')
                ...
                <div class="row">   
                  ...
                  <div class="col-md-4">
                    ...
                    <div class="form-group{{ $errors->has('phone') ? ' has-danger' : '' }}">
                      ...
                      name="phone" id="input-phone" type="phone" value="{{ old('phone') }}"/>
                      @error('phone')
                  ...
                  <div class="col-md-4">
                    ...
                    <div class="form-group{{ $errors->has('zip_code') ? ' has-danger' : '' }}">
                      ...
                      name="zip_code" id="input-zip_code" type="text" value="{{ old('zip_code') }}"/>
                      @error('zip_code')
                  ...
                  <div class="col-md-4">
                    ...
                    <div class="form-group{{ $errors->has('address') ? ' has-danger' : '' }}">
                      ...
                      name="address" id="input-address" type="text" value="{{ old('address') }}"/>
                      @error('address')
