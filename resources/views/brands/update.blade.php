...
<div class="content">
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
          <form method="post" action="{{url('/brands/store/'.$brand->id)}}" autocomplete="off" class="form-horizontal">
            @csrf
            <div class="card ">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('title') ? ' has-danger' : '' }}">
                      <input class="input-upper form-control{{ $errors->has('title') ? ' is-invalid' : '' }}" 
                        required name="title" id="input-title" type="text" value="{{ old('title', $brand->title) }}"/>
                      @error('title')
